          ...
          <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-input rounded-lg bg-muted"
                      readOnly
                    />
                  </div>
                </div>
            ...
            {activeTab === "settings" && (
              <div>
                ...
                <p className="text-muted-foreground">Admin-specific settings will be displayed here.</p>
                {/* Add admin settings like theme preferences, notification settings, etc. */}
              </div>
            )}
          </div>
        </div>
